<div class="box-header with-border">
    <h3 class="box-title"><strong>Income Report: </strong> <i><span id="sector_name">{{ $sector->name }}</span></i></h3>
    <div class="box-tools">
...
<script>
    ...
    function ajax_submission(sector, arr, date) {
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/incomeReport/CategoryFilter',
            data: {
                _token: '{{ csrf_token() }}',
                sector: sector,
                id: arr,
    ...
    function ajax_submission_sector(sector, date) {
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/incomeReport/SectorFilter',
            data: {
                _token: '{{ csrf_token() }}',
                id: sector,
                date: date,
