<!-- Modal -->
<div id="edit_expense_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <!-- Modal content-->
        <div class="modal-content">
            {!! Form::open(['action'=>'ExpenseController@update','method'=>'POST', 'id'=>'expense_update']) !!}
...
<script>
    ...
    $(document).on('submit', '#expense_update', function (e) {
        e.preventDefault();
        $.ajaxSetup({
            headers: {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.ajax_status == 'success') {
                    ...
                    $.ajax({
                        method: 'post',
                        url: '/admin/expense/find_sub_category/',
                        data: {
                            "_token": "{{ csrf_token() }}",
